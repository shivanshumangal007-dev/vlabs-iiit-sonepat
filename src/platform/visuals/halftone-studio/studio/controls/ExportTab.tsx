...
const DEFAULT_IMAGE_FILE_NAME = 'vlabs-logo.svg';
const DEFAULT_IMAGE_LABEL = 'VLabs image';
const REACT_EXPORT_SETTING_OPTIONS: Array<{
  ...
  },
  {
    ...
    description:
      'Wraps the mount node with a StyledVisualMount using @linaria/react and keeps the VLabs-ready mount shape.',
  },
  {
    key: 'includeUseClientDirective',
    label: "Add 'use client'",
    description:
      'Prepends the Next.js client directive so the exported component can be dropped into the VLabs website directly.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Exports both a named component and a default export to match the current VLabs illustration import pattern.',
  },
  {
    key: 'includeRegistryComment',
    label: 'Add VLabs header comment',
    description:
...
export function ExportTab({
  ...
  const animationLabel = HALFTONE_FORMATTERS.animationName(
    settings.animation,
    settings.sourceMode,
  );
  ...
  const { componentName } = HALFTONE_EXPORT_NAMES.resolveArtifactNames(
    exportName,
    defaultExportName,
  );
  ...
  return (
    <CONTROLS_TABS.Content>
      <CONTROLS_SECTION.Section $first>
        ...
        <CONTROLS_PANEL_SHELL.ExportNameInput
      ...
      <CONTROLS_SECTION.Section>
        ...
        <div style={{ marginTop: 12 }}>
          <CONTROLS_SECTION.Title $preserveCase>
            Download
          </CONTROLS_SECTION.Title>
          <div style={{ display: 'flex', gap: 8 }}>
            <CONTROLS_PANEL_SHELL.ExportButton
        ...
        <div style={{ marginTop: 14 }}>
          <CONTROLS_SECTION.Title $preserveCase>Copy</CONTROLS_SECTION.Title>
          <div style={{ display: 'flex', gap: 8 }}>
            <CONTROLS_PANEL_SHELL.ExportButton
      ...
      <CONTROLS_SECTION.Section>
        ...
        <CONTROLS_PANEL_SHELL.ExportPreview>
          <div>
            <span
              style={{ color: '#9d90fa' }}
        ...
        <CONTROLS_PANEL_SHELL.ExportButton onClick={onExportHtml} type="button">
          Download Standalone HTML
        </CONTROLS_PANEL_SHELL.ExportButton>

        <CONTROLS_PANEL_SHELL.ExportNote>
          {isImageMode
