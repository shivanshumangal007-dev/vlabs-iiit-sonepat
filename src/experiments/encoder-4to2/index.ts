...
export const Encoder4to2: Experiment = {
  id: 'encoder-4to2',
  ...
  metaTitle: '4:2 Priority Encoder — VLabs',
  metaDescription: 'A priority encoder converts four active-high input lines to a 2-bit binary code. Built from two OR gates using 74HC32.',
  circuit: {
  id: 'encoder-4to2',
  title: '4:2 Priority Encoder',
  description:
