...
export const Demux1to2: Experiment = {
  id: 'demux-1to2',
  ...
  metaTitle: '1:2 Demultiplexer — VLabs',
  metaDescription: 'A demultiplexer routes a single data input to one of two outputs based on a select line. S=0: Y0=I, Y1=0. S=1: Y0=0, Y1=I.',
  circuit: {
  id: 'demux-1to2',
