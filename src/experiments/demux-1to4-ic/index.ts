...
export const Demux1to4Ic: Experiment = {
  id: 'demux-1to4-ic',
  ...
  metaTitle: '1:4 Demultiplexer using 74HC139 — VLabs',
  metaDescription: 'Configure a 74HC139 dual 2:4 decoder/demultiplexer as a 1:4 DEMUX. Route a single input to one of four outputs via address lines.',
  circuit: {
  id: 'demux-1to4-ic',
  title: '1:4 Demultiplexer using 74HC139',
  description:
