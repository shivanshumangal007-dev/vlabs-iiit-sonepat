...
export const HalfWaveRectifier: Experiment = {
  ...
  metaTitle: 'Half-wave rectifier — VLabs',
  metaDescription: 'Build and analyse a half-wave rectifier circuit using a single 1N4148 diode. Observe pulsating DC output and measure ripple factor.',
  circuit: {
  id: 'half-wave-rectifier',
  title: 'Half-Wave Rectifier',
  description:
